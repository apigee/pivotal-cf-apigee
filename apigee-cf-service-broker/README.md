...
> 1. Click APIs > API Proxies to locate the proxy generated by the `bind-route-service` command.

> 1. Click the proxy to open it, then click the Develop tab on the right.
